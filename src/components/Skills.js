...
const Skills = () => {
  return (
    <div className="page">
      <div>
        <h3 className="skills-categories">
          Web Development Skills, Tech Stack, and More...
        </h3>

        <Alert className="alert">
          <h4>Honorable Mention: Design</h4>
          <p>
            {" "}
            PhotoShop | InDesign | Invitations | Flyers | Advertisements | Basic
            Logos
          </p>{" "}
        </Alert>
        <Alert className="alert">
          {" "}
          <h4>Honorable Mention: Office Skills</h4>
          <p>
            {" "}
            Banking/Bookkeeping | Correspondence, Dictation, Scheduling |
            Accounts Payable/Receiveable | Compliance, Records |
            Quicken/Quickbooks
          </p>
        </Alert>
